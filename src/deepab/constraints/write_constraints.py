...
from src.deepab.constraints import Constraint, ConstraintType, Residue, ResiduePair, constraint_type_generator_dict
from src.deepab.constraints.custom_filters import no_max_distance_filter, local_interaction_filter
from src.deepab.constraints.rosetta_constraint_generators import neg_log_prob_to_energy
from src.deepab.models.AbResNet import AbResNet
from src.deepab.models.ModelEnsemble import ModelEnsemble
from src.util.get_bins import get_dist_bins, get_dihedral_bins, get_planar_bins, get_bin_values
from src.util.model_out import get_logits_from_model, get_probs_from_model, bin_matrix, binned_mat_to_values
from src.util.util import load_full_seq
...
def get_constraint_bin_value_dict(num_out_bins: int,
    ...
    bb_phi_psi_bin_values = get_bin_values(
        get_dihedral_bins(num_out_bins, rad=True))
    ...
    constraint_bin_value_dict = {
        ...
        ConstraintType.bb_phi_dihedral: bb_phi_psi_bin_values,
        ConstraintType.bb_psi_dihedral: bb_phi_psi_bin_values
    }
